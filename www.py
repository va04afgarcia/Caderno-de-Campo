...
def process_caderno(pu_file, template_file):
    ...
    # Dicionário estrito de Intervenções e Medidas Agroambientais do IFAP
    code_mapping = {
        'C.1.1.1': 'UEA (C.1.1.1 – Uso Eficiente dos Recursos Naturais)',
        'C.1.1.1.1': 'CS (C.1.1.1.1 – Conservação do solo)',
        'C.1.1.1.2': 'PB (C.1.1.1.2 – Pastagens biodiversas)',
        'C.1.1.1.3': 'UEA-Água (C.1.1.1.3 – Uso eficiente da água)',
        'C.1.1.2': 'MSE (C.1.1.2 – Manutenção de Sistemas Extensivos)',
        'C.1.1.2.1': 'ML (C.1.1.2.1 – Montados e Lameiros)',
        'C.1.1.2.2': 'CPPT (C.1.1.2.2 – Culturas permanentes e paisagens tradicionais)',
        'C.1.1.2.3': 'MA (C.1.1.2.3 – Mosaico agroflorestal)',
        'C.1.1.3': 'CB (C.1.1.3 – Conservação da biodiversidade)',
        'C.1.1.4': 'GAPB (C.1.1.4 – Gestão pastoril em Baldios)',
        'C.1.1.5': 'CMRGF (C.1.1.5 – Conservação e melhoramento de recursos genéticos)',
        'C.1.1.6': 'APIO (C.1.1.6 – Apoio à apicultura para a biodiversidade)',
        'C.1.1.7': 'PRODI (C.1.1.7 – Produção Integrada)',
        'C.1.1.8': 'AB (C.1.1.8 – Agricultura Biológica)',
        'C.1.1.8.1': 'AB-C (C.1.1.8.1 – Agricultura Biológica - Conversão)',
        'C.1.1.8.2': 'AB (C.1.1.8.2 – Agricultura Biológica)',
        'A.3.3': 'ECO-BIO (A.3.3 – Práticas promotoras da biodiversidade)',
        'A.3.4': 'MSPP (A.3.4 – Maneio sustentável de pastagens permanentes)',
        'A.3.5': 'MEAF (A.3.5 – Melhoria da eficiência alimentar animal)',
        'A.3.6': 'CERT (A.3.6 – Certificação ambiental)',
        'D.2.1': 'PZA (D.2.1 – Planos Zonais Agroambientais)',
        'D.2.4': 'PE-AVES (D.2.4 – Proteção de espécies - Aves)',
        'D.2.5': 'PE-SILVO (D.2.5 – Proteção de espécies - Silvoambientais)'
    }

    intervencoes_lista = []
    
    # Leitura estricta apenas da coluna 'intCodigo' na folha de medidas agroambientais
    ...
    # Leitura estricta na folha de restrições territoriais (caso exista coluna de código de restrição)
    ...
    try:
        df_efetivos = pd.read_excel(excel_file, sheet_name='efetivosPecuariosProprio')
